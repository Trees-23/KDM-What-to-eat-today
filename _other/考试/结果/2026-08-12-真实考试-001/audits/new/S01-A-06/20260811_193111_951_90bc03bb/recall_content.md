...
### result_order=3
source: entity_level
metadata_summary: node_id=201001507, recipe_name=蒜蓉, retrieval_level=entity, search_type=entity_level
...
### result_order=4
source: generation_context
metadata_summary: node_id=201001965, recipe_name=蒜苔炒肉末, category=荤菜, retrieval_level=topic, search_type=topic_level, route_strategy=hybrid_traditional
