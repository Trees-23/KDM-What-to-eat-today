...
- 运行编号：`2026-08-12-new-smoke-003`
- 实现提交：`ef501980451a49e3f884beb7949c68ed0e526921`
- 当前分支：`fix/new-smoke-routing`
- 题库 SHA-256：`a2f0f729e41aa861fe5ca0c42e34c687894444f5873ca6e2673491b6bf328f72`
- 预检时间：`2026-08-12T13:49:19+08:00`

## 服务状态

- /health：`{"service":"RAG System","status":"healthy","timestamp":"2026-08-12 05:49:18.539683"}`
```text
what-to-eat-backend|running|Up 25 seconds (healthy)
what-to-eat-milvus-etcd|running|Up About an hour (healthy)
what-to-eat-milvus-minio|running|Up About an hour (healthy)
what-to-eat-milvus-standalone|running|Up About an hour (healthy)
what-to-eat-neo4j|running|Up About an hour (healthy)
```
...
```json
{
  ...
  "health": {
    "service": "RAG System",
    "status": "healthy",
    "timestamp": "2026-08-12 05:49:10.346291"
  },
  "question_count": 300,
