...
对于“X风味、X味、X口味、蒜香、麻辣”等风味表达，仍使用 PREFERENCE_RECOMMEND。不要把整段风味短语放入 entity_mentions 或 ingredients；应将可理解的基础食材候选填入 flavor_ingredients，例如“番茄风味”填“番茄”，“蒜香味”填“大蒜”，“麻辣口味”填“花椒”“辣椒”。这些只是候选，不能推断为菜谱必含食材，也不能生成 ID；无法可靠拆解时保留空数组。
