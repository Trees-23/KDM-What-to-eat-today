...
DROP CONSTRAINT technique_doc_id_unique IF EXISTS;
DROP CONSTRAINT technique_chunk_id_unique IF EXISTS;
...
// 创建技巧/知识文档节点
RETURN 'Creating TechniqueDoc and TechniqueChunk nodes from tips_nodes.csv';
...
// 创建技巧/知识文档章节关系
RETURN 'Creating tip document chunk relationships from tips_relationships.csv';
